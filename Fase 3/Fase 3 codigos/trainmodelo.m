...
V2 = xlsread('IA/dados atualizados.xlsx',4,'C2:C163');
V3 = xlsread('IA/dados atualizados.xlsx',4,'D2:D163');
V4 = xlsread('IA/dados atualizados.xlsx',4,'E2:E163');
V6 = xlsread('IA/dados atualizados.xlsx',4,'G2:G163');
V15 = xlsread('IA/dados atualizados.xlsx',1,'P2:P163');
...
num_hidden_layers = 1; % Modify this value to change the number of hidden layers

% Set the learning rate (adjust the value as needed)
learnRate = 0.01;  % Learning rate (e.g., 0.01)
...
%for n = 1:num_repetitions
    ...
    performance = perform(net, t, y);
        ...
        % Passo 4: Exibir a matriz de confusão usando a função plotconfusion
figure;
plotconfusion(t, y);
